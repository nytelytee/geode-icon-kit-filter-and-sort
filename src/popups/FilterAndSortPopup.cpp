...
void FilterAndSortPopup::refreshMenuState() {
  ...
  ButtonSprite *authorSprite   = m_buttonMenu->getChildByType<CCMenuItemSpriteExtra>(0)->getChildByIndex<ButtonSprite>(0);
  ...
  else              authorSprite->updateBGImage("IKFS_button_01.png"_spr);
  ...
  ButtonSprite *categorySprite   = m_buttonMenu->getChildByType<CCMenuItemSpriteExtra>(1)->getChildByIndex<ButtonSprite>(0);
  ...
  else              categorySprite->updateBGImage("IKFS_button_01.png"_spr);
  
  std::mt19937 rng{std::random_device()()};

  ButtonSprite *sortSprite   = m_buttonMenu->getChildByType<CCMenuItemSpriteExtra>(2)->getChildByIndex<ButtonSprite>(0);
  if (std::uniform_int_distribution(1, 100)(rng) == 7) {
  ...
  ButtonSprite *displaySettingsSprite = m_buttonMenu->getChildByType<CCMenuItemSpriteExtra>(3)->getChildByIndex<ButtonSprite>(0);
  if (std::uniform_int_distribution(1, 100)(rng) == 7) {
  ...
  m_topMenu->getChildByIndex(4)->getChildByIndex<CCSprite>(0)->setColor(iconKitState.pendingSettings.invert ? ccColor3B{255, 255, 255} : ccColor3B{75, 75, 75});
}
...
void FilterAndSortPopup::onMenuButton(CCObject *sender) {
  ...
  switch (button->getTag()) {
    ...
    case MenuButtonType::IconKitDisplayOptionsPopup: return DisplayOptionsPopup::create(this)->show();
